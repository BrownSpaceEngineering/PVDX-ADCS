function simulate()
    ...
    for i = 1:1000 %iterate
        ...
        true_rotation = true_rotation.quaternion_multiply(delta_q);%apply this rotation
        ...
        body_ref_1 = reference_to_body.apply_rotation(reference_1) + normrnd([0,0,0], measurement_noise);
        body_ref_2 = reference_to_body.apply_rotation(reference_2) + normrnd([0,0,0], measurement_noise);
        ref_readings = [reference_1, reference_2];
        body_msmts = [body_ref_1, body_ref_2];
